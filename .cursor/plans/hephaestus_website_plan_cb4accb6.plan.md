---
name: Hephaestus Website Plan
overview: "Greenfield Next.js site for Hephaestus International: story-driven homepage from Version 3 PDF, centralized approved copy, hybrid navigation matching the live site, and v1 \"Did you know\" cards. Upon approval, write [HEPHAESTUS_WEBSITE_PLAN.md](HEPHAESTUS_WEBSITE_PLAN.md) to the repo root, then scaffold and implement."
todos:
  - id: write-plan-md
    content: After approval, save full plan as HEPHAESTUS_WEBSITE_PLAN.md in repo root
    status: completed
  - id: scaffold-nextjs
    content: Scaffold Next.js App Router + TS + Tailwind + theme tokens per guide
    status: completed
  - id: content-module
    content: Create content/site-content.ts with verbatim PDF copy and TODO flags
    status: completed
  - id: homepage-sections
    content: Build homepage sections slides 1-14 including Did you know cards
    status: completed
  - id: hybrid-routes
    content: Implement /about, /projects, /internships, /blogs, /contact, /login, /privacy
    status: completed
  - id: assets-seo
    content: Add logo.svg from approved hand mark, og-image placeholder, metadata, sitemap, robots
    status: completed
  - id: qa-conflicts
    content: Run guide QA checklist; resolve naming/About conflicts with stakeholder
    status: completed
isProject: false
---
